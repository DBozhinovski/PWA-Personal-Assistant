...
export const data: TrainingData = {
  'greetings.known': {
    documents: ['__system.hello.known__'],
    answers: [
  ...
  'greetings.unknown': {
    documents: ['__system.hello.unknown__'],
    answers: ["Hi! I don't think we've met. What should I call you?", "Hi there, what's your name?"],
  },
  'answers.name': {
    description: 'I can learn your name - type "My name is..."',
    documents: ['My name is #Name', 'You can call me #Name', 'They call me #Name', 'Call me #Name'],
    answers: [
  ...
  None: {
    documents: [],
    answers: ["I don't think I understand that. Type `help` to see a list of everything I can help you with."],
  },
  help: {
    documents: ['help', 'what can you do'],
    answers: [
      () => {
  ...
  joke: {
    ...
    documents: ['tell me a joke', 'I want to hear something funny', 'make me laugh', 'do you know any jokes?'],
    answers: [
      () => {
  ...
  reminder: {
    ...
    documents: ['set a reminder', 'remind me to', 'set an alert'],
    answers: ['Reminder set.'],
  },
};
